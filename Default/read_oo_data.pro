PRO READ_OO_DATA_FILE, filename, wavelengths=wavelengths, dns=dns, datetime=datetime
  ...
  reads, datetime_string, j_datetime, format='(C(CMOI2, 1X, CDI2, 1X, CYI4, 2X, CHI2, 1X, CMI2, 1X, CSI2))'
  ...
  WHILE line NE ">>>>>End Spectral Data<<<<<" DO BEGIN
